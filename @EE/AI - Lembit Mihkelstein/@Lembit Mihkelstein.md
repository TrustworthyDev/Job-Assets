...
Link: 		
DOB:        10/20/1989
Address: 	Herne tn 37, 51007 Tartu, Estonia  (Tartumaa County)
Email: 		lemmihkel89@outlook.com
LinkedIn: 	https://www.linkedin.com/in/lembit-mihkelstein-5659403b9/
Phone:      +372 5847 5998
Time Zone:  EET
...
I’m a Senior AI/ML Engineer with over 10 years of experience building production-grade AI systems, and I’m excited to apply for this role. My work has focused on taking ideas from concept to fully deployed, scalable solutions—especially in the space of LLMs, agentic systems, and real-time AI applications.

Recently, I built a text-to-application platform that transforms natural language into fully functional mini-apps using LLM orchestration (GPT-4o, Claude, Vertex AI) and cloud-native infrastructure on GCP. I’ve also designed end-to-end ML pipelines, intent routing systems, and low-latency microservices that serve real users in production environments.

What sets me apart is that I don’t just experiment with AI—I ship it. I focus on reliability, performance, and real-world impact, making sure systems are scalable, observable, and continuously improving. I’m comfortable owning problems end-to-end, from architecture to deployment and iteration.

I’m especially drawn to your team because you’re building meaningful, real-world applications of AI, and I’d love to contribute by bringing both deep technical expertise and a strong product mindset.
