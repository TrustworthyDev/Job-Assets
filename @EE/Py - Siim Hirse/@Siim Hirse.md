...
LinkedIn: 	https://www.linkedin.com/in/siim-hirse-021ba33b2
New:        https://www.linkedin.com/in/siim-h-a7473a405/
GitHub: 	
Resume:		
Cover:      
...
Apriorit  |  Poznan, Poland  |  Mar 2023 - Apr 2026
• Healthcare & Sports Analytics Industry: Engineered a high-performance impact analytics backend using Python, FastAPI, and AWS, delivering 4× faster biomechanical data processing for athlete injury research.
...
Go Wombat  |  Dnipro, Ukraine  |  Nov 2021 - Feb 2023
...
# Full-Stack Engineer
NERDZ LAB  |  Tallinn, Estonia  |  May 2019 - Oct 2021
...
# Software Engineer          
Elogic Commerce  |  Tallinn, Estonia  |  Jun 2016 - Apr 2019
...
I came across your opening for a Senior Software Engineer, and it immediately felt like a strong match — especially the focus on building scalable systems that deal with real-time data and complex workflows.

Over the past 10+ years, I’ve been working on backend-heavy, distributed platforms across healthcare, energy, and fintech — typically in environments where performance, data integrity, and system reliability actually matter. One of my recent projects involved building a biomechanics analytics platform that processes multi-sensor and video data in real time, where we were able to improve processing speed by 4× while maintaining accuracy for injury research.

A lot of my work sits at the intersection of data, infrastructure, and APIs. I’ve designed high-performance services using Python (FastAPI, Django), built event-driven systems with AWS (Lambda, SQS, Step Functions), and worked extensively with PostgreSQL, DynamoDB, and Redis to handle both structured and high-throughput workloads. I also spend a fair amount of time thinking about system design — how services communicate, how data flows, and how to keep things maintainable as complexity grows.

On the frontend side, I’ve built interactive applications with React, Next.js, and even 3D data visualization using Three.js when the problem called for it — especially in cases where raw data needs to be turned into something people can actually understand and use.

More recently, I’ve been integrating AI workflows (TensorFlow, OpenAI APIs) into production systems — not as a gimmick, but to solve specific problems like classification, automation, and accelerating data processing pipelines.

I’m generally drawn to roles where there’s a mix of technical depth and real-world impact — systems that need to scale, evolve, and actually deliver value beyond the code itself.

If that sounds aligned with what you’re building, I’d be happy to connect and talk more.
